...
let contenedorNoticias = document.querySelectorAll("main");
...
//console.log(sitio.classList.contains("remove"))
//console.log(sitio.classList.contains("dark"))
//console.log(sitio.classList)
//
//console.log(sitio.classList.toogle("remove"))
//console.log(sitio.classList.toogle("remove"))
//console.log(sitio.classList.toogle("remove"))
...
function elegirTema() {
    ...
    let confirmacion = confirm("Desea cambiar al modo oscuro?")
    if(confirmacion){
